...
function createPlotlyComponent(Plotly) {
  ...
  var PlotlyComponent = function (_Component) {
    ...
    function PlotlyComponent(props) {
      ...
      _this.attachWindowResize = _this.attachWindowResize.bind(_this);
      _this.detachWindowResize = _this.detachWindowResize.bind(_this);
    ...
    _createClass(PlotlyComponent, [{
      ...
      value: function componentDidMount() {
        ...
        }).then(this.attachWindowResize).then(this.syncEventHandlers);
      }
    }, {
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        this.p = this.p.then(function () {
          return (hasReactAPIMethod ? Plotly.react : Plotly.newPlot)(_this3.el, {
            data: nextProps.data,
            layout: _this3.applySize(_this3.props.layout),
            config: _this3.props.config,
            frames: _this3.props.frames
          }).then(_this3.syncEventHandlers);
        });
      }
    }, {
      ...
      key: "attachWindowResize",
      value: function attachWindowResize() {
        var _this4 = this;
      ...
      key: "detachWindowResize",
      value: function detachWindowResize() {
        if (this.resizeHandler && isBrowser) {
      ...
      value: function syncEventHandlers() {
        for (var i = 0; i < eventNames.length; i++) {
          ...
          var prop = this.props["on" + eventName];
          var hasHandler = !!this.handlers[eventName];

          if (prop && !hasHandler) {
            var handler = this.handlers[eventName] = this.props["on" + eventName];
